...
class HundredThousendNodesTest {
    /**
    ...
    DirectedWeightedGraph d = getGraph("test\\resources\\G100K.json"); //initialize graph
    DwgMagic thousend = new DwgMagic(d);
    int size = 100000;

    @Test
    void load() {
        thousend.load("test\\resources\\G100K.json");
    ...
    void tsp() {
        ...
        l1.add(this.d.getNode(97161));
        l1.add(this.d.getNode(8172));
        l1.add(this.d.getNode(13665));
